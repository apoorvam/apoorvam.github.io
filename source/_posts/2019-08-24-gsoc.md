---
layout: post
title: "Google Summer Of Code 2019: The curtain falls"
permalink: gsoc
date: 2019-08-24 12:00:00
comments: false
description: "Journey of my GSoC 2019"
keywords: "opensource, gsoc, google, coding, scorelabs, dunner"
categories: gsoc

tags: opensource, dunner, gsoc, google

---

![Google Summer of Code 2019](/images/gsoc_banner.png)

This summer I got selected to be a part of [Google Summer Of Code 2019](https://summerofcode.withgoogle.com) with SCoRe Lab(Sustainable Computing Research Lab) and it just ended. With thousands of lines of code, endless discussions, meetings, pull requests and creative ideas, it was an awesome experience. Though I have worked for software organizations in past, this added a different flavour to it and made me happy. Here is a brief summary of the work.

# Dunner, The Docker Task Runner

![Apoorva - GSOC](images/gsoc_dunner.png)
...
Try out [Dunner](https://github.com/leopardslab/dunner/wiki) and let me know what you think :)